...
`);
  ...
  return (
    <div className='flex items-center flex-col bg-cyan-700 min-h-screen min-w-screen'>
      {!isPreviewerExpanded && (
        <Editor
          text={text}
          setText={setText}
          toggleExpand={toggleEditorExpand}
          toggled={isEditorExpanded}
        />
      )}
      {!isEditorExpanded && (
        <Previewer
          text={text}
          toggleExpand={togglePreviewerExpand}
          toggled={isPreviewerExpanded}
        />
      )}
    </div>
  );
